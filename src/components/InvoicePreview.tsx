...
import { calculateRoundOff } from "../utils/calculations";
        ...
        <div className="invoice-header">
          <div className="header-top-row">
            <div className="gstin-info">
              {userProfile.gstNo
                ? `GSTIN No.: ${userProfile.gstNo}`
                : "GSTIN No.: Not provided"}
            </div>
            <div className="tax-invoice-badge">Tax Invoice</div>
            <div className="mobile-info">
              {userProfile.phone
                ? `Mob.: ${userProfile.phone}`
                : "Mob.: Not provided"}
            </div>
          </div>
            ...
            <div className="header-left">
              {userProfile.logo && (
                <div className="business-logo">
                  <img
                    src={getLogoPath(userProfile.logo)}
                    alt="Business Logo"
                    className="logo-img"
                  />
                </div>
        ...
        <div className="invoice-content">
          <table className="invoice-table">
            ...
            <tbody>
              ...
              <tr className="total-row">
                ...
                <td>
                  <strong>₹{invoice.totalCgst.toFixed(2)}</strong>
                </td>
                <td>
                  <strong>₹{invoice.totalSgst.toFixed(2)}</strong>
                </td>
                <td>
          ...
          <div className="invoice-footer">
            <div className="bank-details">
              ...
              {userProfile.bankDetails.accountNo &&
                userProfile.bankDetails.ifsc && (
                  <p>
                    A/c No: {userProfile.bankDetails.accountNo}, IFS Code:{" "}
                    {userProfile.bankDetails.ifsc}
                  </p>
                )}
            ...
            <div className="amount-words">
              <p>
                <strong>R/O:</strong> ₹{roundedAmount.toFixed(2)}
              </p>
              <p>
                <strong>Rupees In Words:</strong> {invoice.amountInWords}
              </p>
            </div>
            ...
            <div className="signature">
              <p>
                For <strong>{userProfile.businessName.toUpperCase()}</strong>
              </p>
              <br />
